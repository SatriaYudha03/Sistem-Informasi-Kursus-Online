            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                    <div class="flex flex-col gap-y-3">
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Kursus</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{$kursuses}}</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-y-3">
                        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex flex-col gap-y-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{$pesertas}}</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-y-3">
                        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Instruktur</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{$instrukturs}}</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-y-3">
                        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{$kategories}}</h3>
                        </div>
                    </div>
                </div>
                @endrole
                ...
                <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                    ...
                    <a href="{{route('admin.kursuses.create')}}" class="w-fit font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                        Create New Course
                    </a>
                </div>
                @endrole
